...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="lastName" id="lastName" value="<?php echo e(old('firstName')); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="email" id="email" value="<?php echo e(old('firstName')); ?>" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>" type="text" name="age"
                                id="age" value="<?php echo e(old('firstName')); ?>" placeholder="Enter Age">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH C:\Users\aisya\Documents\pfmodul4\resources\views/employees/create.blade.php ENDPATH**/ ?>